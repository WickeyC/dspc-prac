...
int main()
{
    ...
    timer stopwatch;
    {
        std::thread thread1(f1, &timerResult1);
        std::thread thread2(f1, &timerResult2);
        std::thread thread3(f1, &timerResult3);
        std::thread thread4(f1, &timerResult4);
        std::thread thread5(f1, &timerResult5);
        std::thread thread6(f1, &timerResult6);
        std::thread thread7(f1, &timerResult7);
        std::thread thread8(f1, &timerResult8);
    ...
    std::cout << "f1 - f8 execution time " << elapsed << std::endl;
