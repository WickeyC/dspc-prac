...
int main() {
    ...
    std::chrono::time_point<std::chrono::system_clock> request_time_point = std::chrono::system_clock::now();
    ...
    std::chrono::time_point<std::chrono::system_clock> response_time_point = std::chrono::system_clock::now();
    ...
    std::chrono::time_point<std::chrono::system_clock> actual_time_point = std::chrono::system_clock::now();
    ...
    auto latency_time_milis = std::chrono::duration_cast<std::chrono::microseconds>(latency_time).count();
